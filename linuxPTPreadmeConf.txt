...
# Messages rate is very important (logSyncInterval and operLogSyncInterval). Range from -7 to +6. For instance, below -2 or -1, makes the nodes jump to their local clock (instead of the master) because the master cannot mantain the accuraccy needed (too much petitions).
