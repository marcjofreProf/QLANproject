...
sudo ./linuxptp/phc2sys -s CLOCK_REALTIME -c eth0 -O 0 -w -m & #-f PTP2pcConfigQLANprojectSlave.cfg & -m
...
#sudo ./linuxptp/phc2sys -s eth0 -c CLOCK_REALTIME -O 0 -w -m & #-f PTP2pcConfigQLANprojectSlave.cfg & -m
