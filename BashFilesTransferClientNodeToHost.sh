...
sudo scp -r -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null /home/debian/Scripts/OSrealtimeTools/rt-tests/LatencyHistData/ marcjofre@10.0.0.1:/home/marcjofre/Scripts/Scripts/OSrealtimeTools/rt-tests/LatencyHistData/
