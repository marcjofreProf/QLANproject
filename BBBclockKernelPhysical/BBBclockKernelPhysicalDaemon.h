...
private:// Variables
	...
	float RatioFreqAdjustment=0.8;// Maximum and minimum frequency variation allowed
	float RatioAverageFactorClockHalfPeriod=0.9999999; // The lower the more aggresive taking the new computed values
