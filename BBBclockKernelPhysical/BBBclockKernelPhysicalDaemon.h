...
public: //Variables
	...
	unsigned int AdjCountsFreq=625; // Number of clock ticks to adjust to the required frequency (e.g., 32 KHz) to account for having some idle time when resetting DWT_CNT in PRU
	double RatioAverageFactorClockHalfPeriod=0.999999999; // The lower the more aggresive taking the new computed values
	double RatioFreqAdjustment=0.9;// Maximum and minimum frequency variation allowed
