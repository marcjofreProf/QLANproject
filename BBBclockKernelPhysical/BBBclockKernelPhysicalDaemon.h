...
private:// Variables
	...
	using ClockWatch = std::chrono::system_clock;//Seems that with system_clock, it has more swing! system_clock;steady_clock;high_resolution_clock// Might seem that for measuring cycles (like a chronometer) steady_clock is better, system_clock is much better than steady_clock aimed at measuring absolute time (like a watch)
