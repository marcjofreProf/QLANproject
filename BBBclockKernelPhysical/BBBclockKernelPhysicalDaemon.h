...
#define ClockCyclePeriodAdjustment		1024 // Very important parameter. The lower so that it does not continuously increse the generated output clock frequency
