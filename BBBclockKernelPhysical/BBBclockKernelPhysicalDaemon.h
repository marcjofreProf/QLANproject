...
private:// Variables
	...
	float RatioFreqAdjustment=0.6;// Maximum and minimum frequency variation allowed
	...
	float RatioAverageFactorClockHalfPeriod=0.99; // The lower the more aggresive taking the new computed values
