...
private:// Variables
	...
	// Time keeping
	unsigned long long int TimeAdjPeriod=(unsigned long long int)(0.5*ClockCyclePeriodAdjustment*ClockPeriodNanoseconds); // Period at which the clock is adjusted. VEry important parameter
