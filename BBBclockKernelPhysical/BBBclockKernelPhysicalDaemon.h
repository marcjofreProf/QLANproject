...
private:// Variables
	...
	// Time keeping
	unsigned long long int TimeClockMarging=750000;// In nanoseconds. It has to be sufficiently large so that after the sleep the system gets aggresive enough with the busy waiting
