...
private:// Variables
	...
	using ClockChrono = std::chrono::system_clock;// system_clock;steady_clock;high_resolution_clock// Might seem that for measuring cycles (like a chronometer), system_clock is much better than seady_clock aimed at measuring absolute time (like a watch)
