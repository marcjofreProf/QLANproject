...
#define ClockCyclePeriodAdjustment		8192 //  Multiply this value to the ClockPeriodNanoseconds, the value has to be larger than the WaitTimeAfterMainWhileLoop
...
private:// Variables
	...
	double RatioFreqAdjustment=0.025;// Maximum and minimum frequency variation allowed
