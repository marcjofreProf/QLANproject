...
private:// Variables
	...
	double PIDconstant=1.1; // The more larger than 1 the more aggressive to correct (although it can become unstable). Below 1.0 is not aggressively enough to correct fully, eventhought it will try
