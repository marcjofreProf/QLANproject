...
if (PlotPIDHAndlerInfo){
	...
	cout << "Applied: this->PIDconstant*static_cast<double>(this->TimePointClockCurrentAdjFilError): " << this->PIDconstant*static_cast<double>(this->TimePointClockCurrentAdjFilError) << endl;
