...
this->TimePointClockCurrentAdjError=(this->TimePointClockCurrentAdjError-this->TimePointClockCurrentAdjFilError)+(int)(this->TimeAdjPeriod-duration_FinalInitialAdjCountAux);// Error to be compensated for
}
else{
