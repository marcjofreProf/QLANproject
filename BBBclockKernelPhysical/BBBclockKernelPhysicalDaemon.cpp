...
this->TimePointClockCurrentAdjError=(this->TimePointClockCurrentAdjError-static_cast<int>(this->PIDconstant*static_cast<double>(this->TimePointClockCurrentAdjFilError)))+(int)(this->TimeAdjPeriod-duration_FinalInitialAdjCountAux);// Error to be compensated for
}
else{
