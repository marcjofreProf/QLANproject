...
if (PlotPIDHAndlerInfo and iIterPlotPIDHAndlerInfo%1000000000){cout << "pru0dataMem_int[1]: " << pru0dataMem_int[1] << endl;}
...
if (PlotPIDHAndlerInfo and iIterPlotPIDHAndlerInfo%1000000000){cout << "this->NumClocksHalfPeriodPRUclock: " << this->NumClocksHalfPeriodPRUclock << endl;}
...
if (PlotPIDHAndlerInfo and iIterPlotPIDHAndlerInfo%1000000000){cout << "Limited this->NumClocksHalfPeriodPRUclock: " << this->NumClocksHalfPeriodPRUclock << endl;}
