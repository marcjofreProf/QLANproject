...
int main(int argc, char const * argv[]){
 ...
 if (argc>1){// Arguments passed
	 ...
	 if (CKPDagent.RatioFreqAdjustment>=1.0){CKPDagent.MinNumClocksHalfPeriodPRUclock=static_cast<double>(0);}
	 else{CKPDagent.MinNumClocksHalfPeriodPRUclock=(1.0-CKPDagent.RatioFreqAdjustment)*CKPDagent.NumClocksHalfPeriodPRUclock;}
	 CKPDagent.MaxNumClocksHalfPeriodPRUclock=(1.0+CKPDagent.RatioFreqAdjustment)*CKPDagent.NumClocksHalfPeriodPRUclock;
