...
if (this->duration_FinalInitialDriftAuxArrayAvg>1000){// Much longer than for client node (which typically is below 5000) maybe because more effort to serve PTP messages
	cout << "Time for pre processing the time barrier is too long " << this->duration_FinalInitialDriftAuxArrayAvg << " ...adjust TimeClockMarging! Set to nominal value of 1000..." << endl;
	this->duration_FinalInitialDriftAuxArrayAvg=1000;// For the time being adjust it to the nominal initial value
}
