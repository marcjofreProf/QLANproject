...
#ifndef BBBclockKernelPhysicalDaemonSignalDriver_H_
#define BBBclockKernelPhysicalDaemonSignalDriver_H_
#include<string>
#include<cmath>
// Semaphore
#include <atomic>
...
#define PRUclockStepPeriodNanoseconds		4.99974295 // Very critical parameter experimentally assessed. PRU clock cycle time in nanoseconds. Specs says 5ns, but maybe more realistic is the 24 MHz clock is a bit higher and then multiplied by 8 
...
private:// Variables
	...
	struct my_clock
	{
	    ...
	    static constexpr bool is_steady = false;//false, true. With false, probably the corrections are abrupt, but less slots affected by misadjustments in time. True, the corrections are smooth and probably more slots affected by misadjustments in time.
...
#endif /* BBBclockKernelPhysicalDaemonSignalDriver_H_ */
