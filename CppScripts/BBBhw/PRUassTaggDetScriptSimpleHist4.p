...
#define EXITCOUNTER 0x07FFFFFF // almost 10 seconds (since there are many default instructions for each iteration)
...
PERIODICOFFSET: // Neutralizing hardware clock relative frequency difference and offset drift//
	...
	LSR 	r0, r0, 1 // Divide by 2 since the loop consumes two at each iteration
	ADD 	r0, r0, 1 // ADD 1 to not have a substraction below zero which halts
PERIODICOFFSETLOOP:
	SUB		r0, r0, 1
