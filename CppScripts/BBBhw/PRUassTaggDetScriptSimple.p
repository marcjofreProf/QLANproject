...
#define LASTSHAREDRAM 11996 //12000-4 // Address of the last posi iton of the shared RAM
...
QUADDET7:
	...
	JMP		PSEUDOSYNCH
QUADDET6:
	MOV		r11, 0xC000C0F0 //0xC000C0F0 // detection mask
	JMP		PSEUDOSYNCH
QUADDET5:
	MOV		r11, 0xC000C00F //0xC000C08D // detection mask
	JMP		PSEUDOSYNCH
QUADDET4:
...
QUADDET3:
	...
	JMP		PSEUDOSYNCH
QUADDET2:
	MOV		r11, 0x000000F0 //0x0000008D // detection mask
	JMP		PSEUDOSYNCH
QUADDET1:
	MOV		r11, 0x0000000F //0x00000072 // detection mask
	JMP		PSEUDOSYNCH
