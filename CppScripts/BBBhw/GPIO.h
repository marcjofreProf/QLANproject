...
private:// Variables
	...
	int NumSynchMeasAvgAux=9;//51; // Num averages to compute the relative frequency difference. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=9; // Averaging for computing current absolute time offset
