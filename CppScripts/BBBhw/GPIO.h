...
private:// Variables
	...
	int WaitTimeInterruptPRU0=10000000; //5000000 with Simple TTG. 2000000: With overflow counter - In microseconds. 2.5 seconds because the clock can go up to 5 seconds, but has an active range of 2.5 seconds, then discounting some clock misadjustments. 2.0s is safe.
