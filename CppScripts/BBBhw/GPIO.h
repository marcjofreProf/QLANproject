...
private:// Variables
	...
	int NumSynchMeasAvgAux=181;//121//31; // Num averages to compute the time error. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=251;//181; // More averaging for computing interrupts access time
