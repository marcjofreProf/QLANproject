...
private:// Variables
	...
	double truncatedSynchAbsRelFreq=32.0;// Multiple of power of 2, for the periodic monitoring to content the relative frequency difference. Gives stability to the calculation of the relative frequency difference.
