...
private:// Variables
	...
	unsigned int TTGcoincWin=34; // Half the time jitter in PRU units. 1;// It cannot be smaller than 1. Timetagging coincidence window length In PRU units. It reduces time resolution of the detected qubits.
