...
private:// Variables
	...
	unsigned long long int ULLIEpochReOffset=1000000000000000;// Amount to remove to timetaggs so that thier numbers are not so high and difficult to handle by other agents
