...
private:// Variables
	...
	int NumSynchMeasAvgAux=421; // Num averages to compute the time error. Better to be odd number.
	...
	unsigned long long int TimePRU1synchPeriod=50000000;// The faster the more corrections, and less time passed isnce last correction, bu tmore averaging needed.
