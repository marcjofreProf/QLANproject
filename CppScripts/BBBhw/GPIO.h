...
private:// Variables
	...
	int NumSynchMeasAvgAux=401;//401;; // Num averages to compute the time error. Better to be odd number.
	...
	double SynchTrigPeriod=8192; //For slotted analysis. It has to match to the histogram analysis
