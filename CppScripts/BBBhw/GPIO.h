...
private:// Variables
	...
	double SigONPeriod=25; // ON time (duty cycle) of the signal, in PRU time
	...
	unsigned int TTGcoincWin=25;// Timetagging coincidence window length In PRU units. It reduces time resolution of the detected qubits.
