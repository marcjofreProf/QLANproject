...
private:// Variables
	...
	int WaitTimeInterruptPRU0=2000000; // In microseconds. Two seconds because the clock can go up to 5 seconds, but has an active range of 2.5 seconds, then discounting some clock misadjustments. 2s is safe.
