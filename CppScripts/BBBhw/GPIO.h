...
private:// Variables
	...
	unsigned int TTGcoincWin=1; // Wathc out because it can add glitches and rebounces in other channels. // Minimum value 1 (if 1, no coincidence window applied). It is the number of passes (trials). Whatch out, it introduces temporal timetagging jitter.
