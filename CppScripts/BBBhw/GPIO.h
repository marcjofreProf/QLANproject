...
#define NumSynchMeasAvgAux 	131 //351; // Num averages to compute the relative frequency difference. Better to be odd number.
#define ExtraNumSynchMeasAvgAux 	131 // 351 // Averaging for computing current absolute time offset
