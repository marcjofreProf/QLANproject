...
private:// Variables
	...
	int NumSynchMeasAvgAux=251;//51; // Num averages to compute the relative frequency difference. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=201; // Averaging for computing current absolute time offset
