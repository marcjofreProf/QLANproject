...
private:// Variables
	...
	unsigned int TTGcoincWin=16; // Half of the half of the signal time on the time jitter in PRU units. 1;// It cannot be smaller than 1. Timetagging coincidence window length In PRU units. It reduces time resolution of the detected qubits.
