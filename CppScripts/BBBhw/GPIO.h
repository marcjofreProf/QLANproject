...
private:// Variables
	...
	unsigned int TTGcoincWin=2;// It cannot be smaller than 2. Timetagging coincidence window length In PRU units. It reduces time resolution of the detected qubits.
