...
private:// Variables
	...
	int NumSynchMeasAvgAux=3;//51; // Num averages to compute the relative frequency difference. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=3; // Averaging for computing current absolute time offset
