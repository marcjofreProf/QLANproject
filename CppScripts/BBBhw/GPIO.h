...
private:// Variables
	...
	int NumSynchMeasAvgAux=81;//51; // Num averages to compute the relative frequency difference. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=61; // Averaging for computing current absolute time offset
	...
	long long int LLITimePointPRUDiffSystemRelFreq=0;
