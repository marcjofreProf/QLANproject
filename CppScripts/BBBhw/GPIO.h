...
private:// Variables
	...
	int NumSynchMeasAvgAux=251;//121//31; // Num averages to compute the time error. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=301;//181; // More averaging for computing interrupts access time
