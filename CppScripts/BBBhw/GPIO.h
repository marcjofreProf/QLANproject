...
private:// Variables
	...
	unsigned long long int DistTimePRU1synchPeriod=1000; // Number of passes with respect TimePRU1synchPeriod, in order to compute both the absolute time difference and the relative frequency difference
