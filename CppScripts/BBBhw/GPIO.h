...
#define PulseFreq	1000//1000 // Hz// There might be some error in terms of real 1 KHz, the test is to use its own timmer to characterize what a real 1KHz is. Make sure that the timer produces a 1 KHz square singal with respect the clock used. 32.768kHz I think it is not used.
