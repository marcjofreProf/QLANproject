...
private:// Variables
	...
	int SynchCorrectionTimeFreqNoneFlag=3; // Frequency correction is not undercontrol and difficult (better to have good physical synch) //0: No correction; 1: frequency correction; 2: Time correction; 3: time and frequency correction
