...
private:// Variables
	...
	int NumSynchMeasAvgAux=121;//31; // Num averages to compute the time error. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=701; // More averaging for computing interrupts access time
