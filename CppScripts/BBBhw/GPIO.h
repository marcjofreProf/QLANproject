...
private:// Variables
	...
	int NumSynchMeasAvgAux=251;//251; // Num averages to compute the time error. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=301;//301; // More averaging for computing interrupts access time
