...
private:// Variables
	...
	int NumSynchMeasAvgAux=151; // Num averages to compute the time error. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=151; // More averaging for computing interrupts access time
	...
	unsigned long TimePRUcommandDelay=100000;// In nanoseconds. If too large, it disastabilizes the timming performance
