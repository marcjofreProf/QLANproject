...
private:// Variables
	...
	unsigned int TTGcoincWin=10; // Minimu value 1 (if 1, no coincidence window applied). It is the number of passes (trials). Whatch out, it introduces temporal timetagging jitter.
