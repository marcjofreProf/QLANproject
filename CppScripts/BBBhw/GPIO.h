...
private:// Variables
	...
	int NumSynchMeasAvgAux=1;//51; // Num averages to compute the relative frequency difference. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=1; // Averaging for computing current absolute time offset
