...
private:// Variables
	...
	unsigned int TagsSeparationDetRelFreqAdpSlopeSynch=1; // To compute an adaptive slope in synchronization operation where time offsets between qubits are much longer
