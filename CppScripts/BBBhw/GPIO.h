...
private:// Variables
	...
	double SigONPeriod=10.0; // ON time (duty cycle) of the signal, in PRU time. It cannot be smaller than 10. It has to be multiple of 2.
	...
	unsigned int TTGcoincWin=20;// It cannot be smaller than 2. Timetagging coincidence window length In PRU units. It reduces time resolution of the detected qubits.
