...
#define PRUclockStepPeriodNanoseconds		5.00010//4.999925//4.999775 // Very critical parameter experimentally assessed. PRU clock cycle time in nanoseconds. Specs says 5ns, but maybe more realistic is the 24 MHz clock is a bit higher and then multiplied by 8
...
private:// Variables
	...
	int NumSynchMeasAvgAux=421;//31; // Num averages to compute the time error. Better to be odd number.
