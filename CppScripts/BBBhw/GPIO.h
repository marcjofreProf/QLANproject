...
private:// Variables
	...
	int NumSynchMeasAvgAux=201;//401;; // Num averages to compute the time error. Better to be odd number.
	int ExtraNumSynchMeasAvgAux=151;//301; // More averaging for computing interrupts access time
