...
private:// Variables
	...
	double truncatedSynchTrigPeriodPeriodic=16.0;// Multiple of pwer of 2, for the periodic monitoring to content the relative frequency difference. Gives stability to the calculation of the relative frequency difference.
