...
private:// Variables
	...
	double minSigONPeriod=48.0; // Signal ON period at synchronization procedure
	...
	unsigned int TTGcoincWin=4; // Minimu value 1 (if 1, no coincidence window applied). It is the number of passes (trials). Whatch out, it introduces temporal timetagging jitter.
