...
private:// Variables
	...
	int NumSynchMeasAvgAux=181;//31; // Num averages to compute the time error. Better to be odd number.
	...
	int FineSynchAdjVal=0;// Value provided by user space to adjust the triggering of the signals
