...
#define DELAYMODULE	65536 // The whole histogram period. It has to be divisible by the 2^32 total clock register.
...
PERIODICTIMESYNCHADD: // with command coded 2 means synch by reseting the IEP timer
