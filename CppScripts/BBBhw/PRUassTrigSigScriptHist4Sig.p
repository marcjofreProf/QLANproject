...
#define DELAYMODULE	512// Slightly above the std jitter of the 24 MHz hardware clock//65536 // Not used. The whole histogram period. It has to be divisible by the 2^32 total clock register.
#define DELAYHALFMODULE	511//65535 // Not used. One unit less than the power of two required of the period of the histogram which is 65535-1=2^16-1.
#define HALFMODULE	256 // To center the arrival of the interrupt. It is half of DELAYMODULE
