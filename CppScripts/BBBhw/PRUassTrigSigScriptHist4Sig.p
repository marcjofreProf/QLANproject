...
#define DELAY 246// It cannot exceed 255 //Substract 10 for the common cost commands. For instance 118=128-10 //1 * (INS_PER_US / INS_PER_DELAY_LOOP) // in microseconds
