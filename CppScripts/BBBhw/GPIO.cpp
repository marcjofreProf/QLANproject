...
if (this->iIterPRUcurrentTimerValSynch>(this->NumSynchMeasAvgAux)){
	...
	PRUoffsetDriftErrorIntegral=PRUoffsetDriftErrorIntegral+PRUoffsetDriftErrorAvg/EstimateSynch;//*static_cast<double>(iIterPRUcurrentTimerVal-iIterPRUcurrentTimerValLast);//*(static_cast<double>(this->TimePRU1synchPeriod)/static_cast<double>(PRUclockStepPeriodNanoseconds));
}
double PIDconstant;
