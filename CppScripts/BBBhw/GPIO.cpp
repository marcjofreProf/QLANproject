...
unsigned int AfterCountsThreshold=0x00000000;//1E;// Related to the number of instruciton counts after the last read of the IEP timer. It is a parameter to adjust
