...
int GPIO::PRUsignalTimerSynchJitterLessInterrupt(){
	...
	while(true){		
		...
		// Information
		if (this->ResetPeriodicallyTimerPRU1 and (this->iIterPRUcurrentTimerValSynchLong%(512*NumSynchMeasAvgAux)==0) and this->iIterPRUcurrentTimerValSynchLong>NumSynchMeasAvgAux){
