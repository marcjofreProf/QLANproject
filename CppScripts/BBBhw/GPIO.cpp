...
unsigned short GPIO::packBits(unsigned short value) {
    ...
    //unsigned short byte1aux = ((value & 0x0008) << 1) | ((value & 0x0001) << 5) | ((value & 0x0080) >> 1) | ((value & 0x0004) << 5); // Channel 1 // Are the bits 0x008D, moved to 0x00F0
    
    unsigned short byte0aux = ((value & 0x0008) >> 3) | ((value & 0x0001) << 1) | ((value & 0x0080) >> 1) | ((value & 0x0004) << 1); // Channel 0 // Are the bits 0x008D, moved to 0x00F0
    unsigned short byte1aux = ((value & 0x0010)     ) | ((value & 0x0040) >> 1) | ((value & 0x0002) << 5) | ((value & 0x0020) << 2) ; // Channel 1 // Are the bits 0x0072, moved to 0x000F
        
    unsigned short byte2aux = ((value & 0x1000) >> 4) | ((value & 0x2000) >> 4) | ((value & 0x4000) >> 4) | ((value & 0x8000) >> 4); // Channel 2 // To be check that the ordering is correct!!!! // Byte 1 shifts to the right four bit positions (the interesting ones) // Are the bits 0xF000, moved to 0x0F00
