		...
		if (this->ManualSemaphoreExtra==false){// It was possible to execute when needed			
			...
			if (this->ResetPeriodicallyTimerPRU1){
				...
				if (this->PRUcurrentTimerValWrap<=this->PRUcurrentTimerValOldWrap){this->PRUcurrentTimerVal=this->PRUcurrentTimerValWrap+(0xFFFFFFFF-this->PRUcurrentTimerValOldWrap);}
					...
					long long int PRUoffsetDriftErrorAbsAux=0;
					
					if (this->PRUoffsetDriftError<0.0){
						PRUoffsetDriftErrorAbsAux=static_cast<double>((-fmodl((static_cast<long double>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count())+static_cast<long double>(duration_FinalInitialCountAuxArrayAvg))/static_cast<long double>(PRUclockStepPeriodNanoseconds),static_cast<long double>(iepPRUtimerRange32bits)))+(static_cast<long double>(this->PRUcurrentTimerValWrap)-fmodl(static_cast<long double>(-this->PRUoffsetDriftErrorAvg)*static_cast<long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count()),static_cast<long double>(iepPRUtimerRange32bits))));
						//PRUoffsetDriftErrorAbsAux=-(((static_cast<long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count())+static_cast<long long int>(duration_FinalInitialCountAuxArrayAvg))/static_cast<long long int>(PRUclockStepPeriodNanoseconds))%static_cast<long long int>(iepPRUtimerRange32bits))+(static_cast<long double>(this->PRUcurrentTimerValWrap)-0*((static_cast<long long int>(-this->PRUoffsetDriftErrorAvg)*static_cast<long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count())/static_cast<long long int>(PRUclockStepPeriodNanoseconds))%static_cast<long long int>(iepPRUtimerRange32bits))); 
					}
					else{
						PRUoffsetDriftErrorAbsAux=static_cast<double>((-fmodl((static_cast<long double>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count())+static_cast<long double>(duration_FinalInitialCountAuxArrayAvg))/static_cast<long double>(PRUclockStepPeriodNanoseconds),static_cast<long double>(iepPRUtimerRange32bits)))+(static_cast<long double>(this->PRUcurrentTimerValWrap)+fmodl(static_cast<long double>(this->PRUoffsetDriftErrorAvg)*static_cast<long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count()),static_cast<long double>(iepPRUtimerRange32bits))));
						//PRUoffsetDriftErrorAbsAux=-(((static_cast<long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count())+static_cast<long long int>(duration_FinalInitialCountAuxArrayAvg))/static_cast<long long int>(PRUclockStepPeriodNanoseconds))%static_cast<long long int>(iepPRUtimerRange32bits))+(static_cast<long long int>(this->PRUcurrentTimerValWrap)+0*((static_cast<long long int>(this->PRUoffsetDriftErrorAvg)*static_cast<long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(this->TimePointClockCurrentSynchPRU1future.time_since_epoch()).count())/static_cast<long long int>(PRUclockStepPeriodNanoseconds))%static_cast<long long int>(iepPRUtimerRange32bits))); 
					}
