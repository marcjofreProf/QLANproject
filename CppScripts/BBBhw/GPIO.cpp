...
unsigned short GPIO::packBits(unsigned short value) {
    ...
    unsigned short byte0aux = ((value & 0x0010) >> 4) | ((value & 0x0040) >> 5) | ((value & 0x0020) << 1) | ((value & 0x0020) >> 5) ; // Channel 0 // Are the bits 0x0072, moved to 0x000F
    unsigned short byte1aux = ((value & 0x0008) << 4) | ((value & 0x0001) << 1) | ((value & 0x0080) >> 3) | ((value & 0x0001) << 4); // Channel 1 // Are the bits 0x008D, moved to 0x00F0
