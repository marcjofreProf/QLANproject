...
long double InstantCorr=static_cast<long double>(AccumulatedErrorDrift)+static_cast<long double>(50.0*PRUoffsetDriftErrorAvg)*static_cast<long double>((static_cast<unsigned long long int>(std::chrono::duration_cast<std::chrono::nanoseconds>(TimePointClockTagPRUinitial.time_since_epoch()).count())/static_cast<unsigned long long int>(1000000000/PRUclockStepPeriodNanoseconds))%static_cast<unsigned long long int>(SynchTrigPeriod));
long double SignAux;
