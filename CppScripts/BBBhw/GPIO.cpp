		...
		if (this->ManualSemaphoreExtra==false){// It was possible to execute when needed			
			...
			if (this->ResetPeriodicallyTimerPRU1){
				...
				if (this->PRUcurrentTimerValWrap<=this->PRUcurrentTimerValOldWrap){this->PRUcurrentTimerVal=this->PRUcurrentTimerValWrap+(0xFFFFFFFF-this->PRUcurrentTimerValOldWrap);}
					...
					//this->PRUoffsetDriftErrorAbs=static_cast<double>(-fmodl((static_cast<long double>(this->iIterPRUcurrentTimerVal)*static_cast<long double>(this->TimePRU1synchPeriod)+static_cast<long double>(duration_FinalInitialCountAux))/static_cast<long double>(PRUclockStepPeriodNanoseconds),static_cast<long double>(iepPRUtimerRange32bits))+fmodl(static_cast<long double>(this->PRUcurrentTimerVal)+static_cast<long double>(this->PRUoffsetDriftError)*static_cast<long double>(TimePRU1synchPeriod)*static_cast<long double>(this->iIterPRUcurrentTimerVal),static_cast<long double>(iepPRUtimerRange32bits))); // Substract (it is a sum because relative error is already negated) the relative error // // The multiplication by SynchTrigPeriod is done before applying it in the Triggering and TimeTagging functions
					this->PRUoffsetDriftErrorAbs=static_cast<double>(-fmodl((static_cast<long double>(this->iIterPRUcurrentTimerVal)*static_cast<long double>(this->TimePRU1synchPeriod)+static_cast<long double>(duration_FinalInitialCountAuxArrayAvg))/static_cast<long double>(PRUclockStepPeriodNanoseconds),static_cast<long double>(iepPRUtimerRange32bits))+fmodl(static_cast<long double>(this->PRUcurrentTimerVal)+static_cast<long double>(this->PRUoffsetDriftErrorAvg)*static_cast<long double>(TimePRU1synchPeriod)*static_cast<long double>(this->iIterPRUcurrentTimerVal),static_cast<long double>(iepPRUtimerRange32bits))); // Substract (it is a sum because relative error is already negated) the relative error // // The multiplication by SynchTrigPeriod is done before applying it in the Triggering and TimeTagging functions
