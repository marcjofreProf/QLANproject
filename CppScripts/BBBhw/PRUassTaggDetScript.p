...
#define MAX_VALUE_COUNTER_BEFORE_RESET 0x7FFFFFFF // Using one bit less of the length of the register to avoid overflow occuring in the time of execution of TIMETAG
...
CHECK_CYCLECNT: // This instruciton block has to contain the minimum number of lines and the most simple possible, to better approximate the DWT_CYCCNT clock skew
	...
	QBLE	RESET_CYCLECNT, r5, MAX_VALUE_COUNTER_BEFORE_RESET // If MAX_VALUE_COUNTER_BEFORE_RESET <= r5, go to RESET_CYCLECNT. Account that we lose 2 cycle counts
