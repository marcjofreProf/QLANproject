...
// Synchronization
#define NumCalcCenterMass 1 // Number of centers of mass to measure to compute the synchronization
...
private: // Variables/Objects	
	...
	double QTLAHFreqSynchNormValuesArray[NumCalcCenterMass]={0.0};//,-0.5,0.5}; // Normalized values of frequency testing// Relative frequency difference normalized
	// Scheduler status
