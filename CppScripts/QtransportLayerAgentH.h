...
private: // Variables/Objects	
	...
	unsigned long long int MaxiIterNetworkSynchcurrentTimerVal=50;//2160; // Counter value to reset network synchronization, which is actually multiplied by the variable MaxiIterPeriodicTimerVal. E.g, every 6 hours
	...
	unsigned long long int MaxiIterPeriodicBlockTimer=100000;//3600000; // Counter of how much passes the host is constantly block. If larger than , unblock itself
