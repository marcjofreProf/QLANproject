...
private: // Variables/Objects	
	...
	double TestPeriodFactorAux=0.5; // Scales the HistPeriodicity and Number of RepetitionSignal. The larger the period, the more probable that the relative frequency difference will be well measured/Captured. The larger the resulting HistPeriodicityAuxAux the larger range of initial relative frequency difference it can be handled
