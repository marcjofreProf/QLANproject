...
private: // Variables/Objects	
	...
	double HistPeriodicityAuxAux=1024.0/TestPeriodFactorAux;// Histogram value by default to perform network synchronization. If it is too large, then it is difficult to recover the slope in GPIO and hence fit in the acceptability window defined in QphysLayerAgent FilteringAcceptWindowSize
