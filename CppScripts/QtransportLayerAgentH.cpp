...
this->release();
this->RelativeNanoSleepWait((unsigned long long int)(500*(unsigned long long int)(WaitTimeAfterMainWhileLoop)));// Give some time to relax things, and maybe let others enter
return 0; // All ok
}
