...
private: //Variables/Instances		
	int numberLinks=0;// Number of full duplex links directly connected to this physical quantum node
        ...
        float QuBitsPerSecondVelocity[LinkNumberMAX]={100000.0}; // Array indicating the qubits per second velocity of each emit/receive pair 
        int QuBitsNanoSecPeriodInt[LinkNumberMAX]={10000};
        int QuBitsNanoSecHalfPeriodInt[LinkNumberMAX]={5000};
        int QuBitsNanoSecQuarterPeriodInt[LinkNumberMAX]={2500};// Not exacte quarter period since it should be 2.5
        // Semaphore
