...
private: //Variables/Instances	
	...
	double SplitEmitReceiverSmallOffsetDriftPerLink=0.9; // Splitting ratio between the effort of the emitter and receiver of constantly updateing the synch values
