...
#define NumQuBitsPerRun 1024 // Really defined in GPIO.h. Max 2048
// String operations
#include<string>
#include<fstream>
// Threading
...
private: //Variables/Instances		
	...
	unsigned long long int TimeClockMarging=500000;// In nanoseconds. So that we can do a busy wait to be more accurate and responsive.
	// Private threads
