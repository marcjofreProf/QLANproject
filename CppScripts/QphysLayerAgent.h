...
//Qubits
#define NumQubitsMemoryBuffer 8192//4096 // In multiples of 2048. Equivalent to received MTU (Maximum Transmission Unit) - should be in link layer - could be named received Quantum MTU
