...
private: //Variables/Instances	
	...
	double SynchNetworkParamsLinkOther[LinkNumberMAX][3]={0.0}; // Stores the synchronization parameters corrections to apply depending on the node to whom receive or send from the other nodes. Zeroed at the begining
	...
	double SplitEmitReceiverSmallOffsetDriftPerLinkP=0.25; // Proportional values for the PID
