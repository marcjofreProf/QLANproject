...
#define NumSmallOffsetDriftAux 9 // Length of samples to filter the small time offset continuous correction
// String operations
#include<string>
#include<fstream>
// Threading
...
private: //Variables/Instances	
	...
	long long int CoincidenceWindowPRU=150;//Size of the coincidence window for evaluating coincidences in PRU time, related to jitter and the fact that there are inter corrections for each quad channel
	...
	double SplitEmitReceiverSmallOffsetDriftPerLink=0.05; // Splitting ratio between the effort of the emitter and receiver of constantly updateing the synch values. The closer to zero the more aggresive
