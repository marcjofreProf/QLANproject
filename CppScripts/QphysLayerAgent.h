...
//Qubits
#define NumQubitsMemoryBuffer 1964// In multiples of NumQuBitsPerRun. Equivalent to received MTU (Maximum Transmission Unit) - should be in link layer - could be named received Quantum MTU
