...
private: //Variables/Instances	
	...
	long long int CoincidenceWindowPRU=128;//Size of the coincidence window for evaluating coincidences in PRU time, related to jitter and the fact that there are inter corrections for each quad channel
