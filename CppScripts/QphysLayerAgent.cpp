...
if (string(this->SCmode[0])==string("client")){
	 char ParamsCharArray[NumBytesPayloadBuffer]="EmitLinkNumberArray[0]_48_ReceiveLinkNumberArray[0]_60_QuBitsPerSecondVelocity[0]_100000_";// Set initialization value for the other node
