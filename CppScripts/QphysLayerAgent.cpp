...
#include <atomic>
// time points
#define WaitTimeToFutureTimePoint 299000000 // Max 999999999. It is the time barrier to try to achieve synchronization. Considered nanoseconds (it can be changed on the transformatoin used)
//Qubits
