...
// Threading
#include <thread>
#define WaitTimeAfterMainWhileLoop 50000000 // nanoseconds
// Payload messages
...
while(true){
	...
	ProtectionSemaphoreTrap++;
		if (ProtectionSemaphoreTrap>UnTrapSemaphoreValueMaxCounter){this->release();cout << "QNLA::Releasing semaphore!!!" << endl;}// Avoid trapping situations
