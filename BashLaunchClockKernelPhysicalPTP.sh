...
sudo ./linuxptp/phc2sys -s eth0 -c CLOCK_REALTIME -O 0 -w -m & #-f PTP2pcConfigQLANprojectSlave.cfg & #-m # Seems important that phc2sys is launched first (not on slave)
